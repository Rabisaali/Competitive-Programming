...
signed main () {
    ...
    f(i, 1, n+1) {
        if (n%i == 0) {
            ...
            if (s.find('1')!=string::npos || s.find('2')!=string::npos || s.find('3')!=string::npos || s.find('5')!=string::npos || s.find('6')!= string::npos || s.find('8')!=string::npos || s.find('9')!=string::npos || s.find('0')!=string::npos) {
                continue;
            }   
            else {
                //cout << i << " ";
